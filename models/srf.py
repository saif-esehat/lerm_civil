...
class LermSampleForm(models.Model):
    ...
    discipline_id = fields.Many2one('res.partner',string="Discipline")
    group_id = fields.Many2one('res.partner',string="Group")
    material_id = fields.Many2one('res.partner',string="Material")
    brand = fields.Char(string="Brand")
    size_id = fields.Many2one('res.partner',string="Size")
    grade_id = fields.Many2one('res.partner',string="Grade")
    sample_qty_id = fields.Many2one('res.partner',string="Sample Quantity")
