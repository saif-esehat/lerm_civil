...
class PaverBlock(models.Model):
    ...
    areas1 = fields.Integer(string="Area of Paver Block, mm2")  
    areas2 = fields.Integer(string="Area of Paver Block, mm2") 
    areas3 = fields.Integer(string="Area of Paver Block, mm2") 
    areas4 = fields.Integer(string="Area of Paver Block, mm2") 
    areas5 = fields.Integer(string="Area of Paver Block, mm2") 
    areas6 = fields.Integer(string="Area of Paver Block, mm2") 
    areas7 = fields.Integer(string="Area of Paver Block, mm2") 
    areas8 = fields.Integer(string="Area of Paver Block, mm2") 

    crushing_load1 = fields.Integer(string="Crushing Load, KN")
    crushing_load2 = fields.Integer(string="Crushing Load, KN")
    crushing_load3 = fields.Integer(string="Crushing Load, KN")
    crushing_load4 = fields.Integer(string="Crushing Load, KN")
    crushing_load5 = fields.Integer(string="Crushing Load, KN")
    crushing_load6 = fields.Integer(string="Crushing Load, KN")
    crushing_load7 = fields.Integer(string="Crushing Load, KN")
    crushing_load8 = fields.Integer(string="Crushing Load, KN")
