...
class ConcreteCoreDensityDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.concrete_core_density_datasheet'
        _description = 'Concrete Core Density DataSheet'
...
class ConcreteCoreDensityReport(models.AbstractModel):
    _name = 'report.lerm_civil.concrete_core_density_report'
    _description = 'Concrete Core Density Report'
