...
class PtGrout(models.Model):
    ...
    # initial_conformity = fields.Selection([
    #     ('pass', 'Pass'),
    #     ('fail', 'Fail'),
    # ], string='Conformity', default='fail',compute="_compute_initial_conformity")

    # # initial_nabl = fields.Selection([
    # #     ('pass', 'NABL'),
    # #     ('fail', 'Non-NABL'),
    # # ], string='NABL', default='NABL',compute="_compute_initial_nabl")


    # @api.depends('initial_setting_time_minutes_unrounded','eln_ref','grade')
    # def _compute_initial_conformity(self):
    #     for record in self:
    #         record.initial_conformity = 'fail'
    ...
    #                     record.initial_conformity = 'pass'
    #                     break
    #                 else:
    #                     record.initial_conformity = 'fail'
    ...
    # #                 upper = float(record.initial_setting_time_minutes_unrounded) + float(record.initial_setting_time_minutes_unrounded)*mu_value
    # #                 if lower >= lab_min and upper <= lab_max:
    # #                     record.initial_nabl = 'pass'
    # #                     break
    # #                 else:
    # #                     record.initial_nabl = 'fail'
    # intial_nabl = fields.Selection([
    #     ('pass', 'NABL'),
    #     ('fail', 'Non-NABL')],string="NABL",compute="_compute_intial_nabl",store=True)



    # @api.depends('initial_setting_time_minutes_unrounded','eln_ref')
    # def _compute_intial_nabl(self):
        
    #     for record in self:
    #         record.intial_nabl = 'fail'
    #         line = self.env['lerm.parameter.master'].search([('internal_id','=','0fd53f55-7350-4597-8057-139ef15f07fe')])
    #         materials = self.env['lerm.parameter.master'].search([('internal_id','=','0fd53f55-7350-4597-8057-139ef15f07fe')]).parameter_table
    #         for material in materials:
    #             # if material.grade.id == record.grade.id:
    ...
    # final_conformity = fields.Selection([
    #     ('pass', 'Pass'),
    #     ('fail', 'Fail'),
    # ], string='Conformity', default='fail',compute="_compute_final_conformity")

 

    # @api.depends('final_setting_time_minutes_unrounded','eln_ref','grade')
    # def _compute_final_conformity(self):
    #     for record in self:
    #         record.final_conformity = 'fail'
    ...
    # final_nabl = fields.Selection([
    #     ('pass', 'NABL'),
    #     ('fail', 'Non-NABL')],string="NABL",compute="_compute_final_nabl",store=True)



    # @api.depends('final_setting_time_minutes_unrounded','eln_ref')
    # def _compute_final_nabl(self):
        
    #     for record in self:
    #         record.final_nabl = 'fail'
    #         line = self.env['lerm.parameter.master'].search([('internal_id','=','9377b0ab-5cad-4cbe-a6f5-1cee158d2d0e')])
    #         materials = self.env['lerm.parameter.master'].search([('internal_id','=','9377b0ab-5cad-4cbe-a6f5-1cee158d2d0e')]).parameter_table
    #         for material in materials:
    #             # if material.grade.id == record.grade.id:
    ...
    # @api.depends('final_bleeding','eln_ref')
    # def _compute_bleedin1_nabl(self):
        
    #     for record in self:
    #         record.bleedin_nabl_pt = 'fail'
    #         line = self.env['lerm.parameter.master'].search([('internal_id','=','950eafa7-9b4f-4025-b34c-75a33149cc6f')])
    #         materials = self.env['lerm.parameter.master'].search([('internal_id','=','950eafa7-9b4f-4025-b34c-75a33149cc6f')]).parameter_table
    #         for material in materials:
    #             # if material.grade.id == record.grade.id:
    ...
    # compressive_strength_nabl_pt = fields.Selection([
    #     ('pass', 'NABL'),
    #     ('fail', 'Non-NABL')],default="NABL",compute="compressive_strength_nabl",store=True)


    # @api.depends('water_cement_ratio_1','eln_ref')
    # def compressive_strength_nabl(self):
        
    #     for record in self:
    #         record.compressive_strength_nabl_pt = 'fail'
    ...
    #                 if lower >= lab_min and upper <= lab_max:
    #                     record.compressive_strength_nabl_pt = 'pass'
    #                     break
    #                 else:
    #                     record.compressive_strength_nabl_pt = 'fail'
