...
class CoarseAggregateReport(models.AbstractModel):
    _name = 'report.lerm_civil.lerm_coarse_aggregate_mech_report'
    ...
    def _get_report_values(self, docids, data):
        ...
        coarse_data = self.env[model].sudo().search([("id","=",eln.model_id)])
        return {
            'eln': eln,
            'data': coarse_data,
            'qrcode': qr_code,
...
class CoarseAggregateDataSheet(models.AbstractModel):
    _name = 'report.lerm_civil.coarse_aggregate_datasheet'
