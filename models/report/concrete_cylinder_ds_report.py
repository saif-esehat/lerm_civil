...
class ConcreteCylinderCompresiveDatasheet(models.AbstractModel):
    _name = 'report.lerm_civil.compresive_concrete_cylinder_datasheet'
    _description = 'Compresive Strength Cylinder DataSheet'
...
class ConcreteCylinderCompresiveReport(models.AbstractModel):
    _name = 'report.lerm_civil.compresive_concrete_cylinder_report'
    _description = 'Compresive Strength Cylinder Report'
