...
class GypsumPlasterDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.gypsum_plaster_datasheet'
        _description = 'Gypsum Plaster DataSheet'
...
class GypsumPlastereport(models.AbstractModel):
    _name = 'report.lerm_civil.gypsum_plaster_report'
    _description = 'Gypsum Plaster Report'
