...
class PaverBlockDatasheet(models.AbstractModel):
        _name = 'report.lerm_civil.lerm_paver_block_datasheet'
        _description = 'Paver Block DataSheet'
...
class PaverBlockReport(models.AbstractModel):
    _name = 'report.lerm_civil.paver_block_report'
